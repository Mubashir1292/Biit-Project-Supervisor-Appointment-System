...
function HelpRequests() {
  ...
  const [isPremitted, setIsPremitted] = useState(false);
  ...
  //* toggling the screen
  const handleToggleUpdateScreen = () => {
    setIsPremitted((curr) => !curr);
    // console.log(isPremitted);
  };
  const handleDate = (e) => {
    ...
    setUpdatedDate(selectedDate); // Update updatedDate state
    setDate(selectedDateString); // Update date state
      ...
      {!isPremitted ? (
        <>
          <div className="flex flex-col justify-center items-center">
            ...
            <div className="bg-gray-200 p-3 mt-3 rounded w-8/12">
            ...
            <div className="bg-gray-200 rounded p-3 mt-3 w-8/12">
            ...
            <div className="flex space-x-3 mt-3">
              ...
              <button
                className="bg-green-600 text-white border border-green-600 hover:bg-white hover:text-green-600 px-3 py-2 rounded-lg hover:font-bold transition-all ease-in-out"
                onClick={handleToggleUpdateScreen}
              >
                Update Time
              </button>
            </div>
        ...
        <>
          <div className="flex flex-col justify-center items-center space-y-2">
            ...
            <div className="bg-gray-200 py-2 mt-3 w-8/12">
