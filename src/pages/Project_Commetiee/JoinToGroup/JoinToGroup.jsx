    ...
    <React.Fragment>
      <div className="flex flex-col justify-center items-center">
        ...
        {allRequests && allRequests.length > 0 ? (
              ...
              allRequests?.map((request, index) => (
                <Card className="max-[320px]:w-[320px]" key={index}>
                  <div className="flex flex-col justify-center items-center space-x-3">
                        ...
                        <tbody>
                          {
                            <tr className="cursor-default">
                              ...
                              <td className="text-xs">
                                {request &&
                                  request?.requestDetails?.student?.student_id}
                              </td>
                              <td className="text-xs">
                                {request &&
                              ...
                              <td className="text-xs">
                                {request &&
                                  request?.requestDetails?.student?.technology}
                              </td>
                              <td className="text-xs">
                                {request &&
                              ...
                              <td className="text-xs">
                                {request &&
                                  request?.requestDetails?.student?.semester}
                              </td>
                              <td className="text-xs">
                                {request &&
                              ...
                              <td className="text-xs">
                                {request &&
                                  request?.requestDetails?.student?.section}
                              </td>
                            </tr>
                          }
                        </tbody>
                    ...
                    <Card.Body>
                      ...
                      <Card.Title className="flex justify-center items-center space-x-3">
                        ...
                        <span className="text-sm font-semibold">
                          {request && request?.requestDetails?.teacher?.title}
                        </span>
                      </Card.Title>
                      ...
                      <Card.Subtitle className="flex justify-center items-center space-x-2">
                        ...
                        <span className="text-sm">
                          {request &&
                            request?.requestDetails?.group_cgpa?.toFixed(2)}
                        </span>
                      </Card.Subtitle>
                    </Card.Body>
                  </div>
                  ...
                  >
                    ...
                    <tbody>
                      {request &&
                        request?.groupMembersDetails?.map((item, index) => (
          ...
          <span>No Group Joining Request Founded</span>
        )}
      </div>
    </React.Fragment>
  );
